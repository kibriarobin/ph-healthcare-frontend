...
import { patientZodRegisterSchema } from "@/validation";
...
export function RegisterForm() {
  ...
  type PatientDefaultValues = z.infer<typeof patientZodRegisterSchema>;

  const defaultValues: PatientDefaultValues = {
    name: "Rahat",
    email: "rahat@gmail.com",
    contactNumber: "01871793020",
    password: "Rahat@#12345",
    confirmPassword: "Rahat@#12345",
  };
  ...
  const form = useForm({
    defaultValues,
    validators: {
      onSubmit: patientZodRegisterSchema,
    },
